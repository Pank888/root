...
function mountHost(M, s, dir) {
	M.log('dir = ', path.join(dir, 'package.json'));
	...
	for (var subhost in hosts ) {
		...
		M.log('vhosts started for subhost ' + hosts[subhost]);
	}
}
